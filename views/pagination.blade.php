    ...
    <div class="row">
        ...
        <div class="col-lg">
            ...
            <div id="query" style="margin-top: 5%;">
                ...
                <a href="#queries"><h3 style="font-weight: bold"><span class="hashtag">#</span> Usage</h3></a>
                <a href="#queries"><h4 style="font-weight: bold"><span class="hashtag">#</span> Paginating Query Results</h4></a>
                <p style="font-size: 1rem;line-height: 1.8rem;color:#2b2e38">
